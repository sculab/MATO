...
erh:
    ...
    Public Sub info()
        Try
            ...
            Analysisform.RichTextBox1.AppendText("Note: The following karyotype asymmetry coefficients are seldom used nowadays and are provided here solely for reference purposes." + Chr(13))
